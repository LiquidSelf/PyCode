...
public class GuiTextArea extends Gui
{
    ...
    public int xPosition, yPosition, width, height, maxRows, textYOffset, textXOffset, xScissor, yScissor, wScissor, hScissor;
    private boolean isFocused;
    private int cursorCounter = 0, cursorRow = 0, cursorColumn = 0;
